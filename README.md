# ProjTest_2 Configurations

This repository contains all the configuration resources required for the ProjTest_2 project to function properly and expose its business features.
